...
function Login() {
  ...
  return (
    <>
      <Helmet>
        <title>Connexion - STARTERKITCM</title>
      </Helmet>
        ...
        >
          ...
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            ...
            <p style={{ fontSize: '14px', color: '#6b7280' }}>
              Connectez-vous pour accéder à votre espace entrepreneur
            </p>
          </div>
          ...
          <p style={{ textAlign: 'center', marginTop: '24px', fontSize: '14px', color: '#6b7280' }}>
            ...
            <Link to="/signup" style={{ color: '#635bff', fontWeight: 600, textDecoration: 'none' }}>
              Créer un compte
            </Link>
          </p>
        </motion.div>
